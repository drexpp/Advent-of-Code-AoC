...
public class Day2_2017 {
 ...
 public static void main(String[] args) {
  ...
  System.out.println(result);
	...
	public static Integer checkSum(String input){
	  Integer result = 0;

	
	  ArrayList<Integer> list_results = new ArrayList<Integer>();
	  ...
	  for(String line : input.split("\n")){
		  ...
		  int highest = nums.get(0), lowest = nums.get(0);
			...
			list_results.add(highest-lowest);
	  }
	  
	  for(Integer a : list_results){
		  result += a;
	  }
